    ...
    <div class="container mb-5" style="margin-top: 200px">
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4 gallery-grid">
            @foreach ( $images as $img )
                <div class="col">
                    <a class="gallery-item" href="{{Voyager::image($img)}}">
                    <img src="{{Voyager::image($gallery->getThumbnail($img,'medium'))}}" class="img-fluid" alt="{{$gallery->title}}">
                    </a>
                </div>
            @endforeach
        </div>
    ...
    <script>
        ...
        function createSlides (img) {
            ...
            markup += `
                ...
                <img class="d-block img-fluid w-100 img-gallery" src=${imgSrc} alt="${imgAlt}">

        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                <div class="feature-one__box">
                    ...
                    <h3 class="feature-one__box__title">Reserva Fácil y Rápida</h3>
                    <p class="feature-one__box__text">Reserva tu servicio en unos pocos clics con nuestra interfaz amigable</p>
                </div><!-- feature-item -->
            </div>

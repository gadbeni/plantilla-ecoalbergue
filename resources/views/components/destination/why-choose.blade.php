            ...
            <div class="col-lg-6 col-xl-6 wow fadeInLeft" data-wow-delay="200ms">
                <div class="why-choose-two__content">
                    <div class="sec-title text-left">
                        ...
                        <p class="sec-title__tagline">¿ESTÁS LISTO PARA VIAJAR?</p><!-- /.sec-title__tagline -->

                        <h2 class="sec-title__title">Elija nuestros tipos de tours & disfrútelos ahora</h2>
                        <!-- /.sec-title__title -->
                    </div><!-- /.sec-title -->
                    ...
                    <div class="why-choose-two__box-wrapper">
                        <div class="why-choose-two__box">
                            ...
                            <h4 class="why-choose-two__box__title">Precio bajo amigable</h4>

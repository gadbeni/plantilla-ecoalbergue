            ...
            <div class="col-lg-6 wow fadeInRight" data-wow-delay="200ms">
                <div class="benefit-two__content">
                    <div class="sec-title text-left">
                        <p class="sec-title__tagline" style="font-size: 20px; font-weight: bold;">Descubre las Ventajas de Viajar con Nosotros</p><!-- /.sec-title__tagline -->

                        <h2 class="sec-title__title">¿Por qué deberías elegir <br> nuestros Servicios de Viaje?</h2>
                        <!-- /.sec-title__title -->
                    </div><!-- /.sec-title -->
                    <!-- /.sec-title -->
                    ...
                    <div class="benefit-two__box">
                        ...
                        <p class="benefit-two__box__text">
                            Contactanos:<br>
                            <a href="https://www.facebook.com/Aguaysalecoalbergue" target="_blank">Agua y sal ecoalbergue</a> <br>
                            <a href="mailto:aguaysalecoalbergue@gmail.com"target="_blank">aguaysalecoalbergue@gmail.com</a><br>
                            <a href="https://wa.me/59171124428"target="_blank">WhatsApp: (591) 71124428</a>
                        </p>
                    </div><!-- /.benefit-box -->
                </div>
            </div>
